...
"""
#Note: python setuptools is required for this to run. Either launch this program using
#the homebrewed python (path at the top of the page), or manually add the path:
